...
object ValhallaConfig {
    ...
    fun writeConfig(
        ...
        val json = JSONObject(DEFAULTS)
        val mjolnir = json.getJSONObject("mjolnir")
        mjolnir.put("tile_extract", tileExtract)
        mjolnir.put("admin", admin)
        mjolnir.put("timezone", timezone)
    ...
    // Bundled default config from valhalla-mobile. Only mjolnir paths are
    // overridden at runtime; everything else (service_limits, etc.) is used as-is.
